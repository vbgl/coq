...
let make_eq () =
  try
    EConstr.of_constr (Universes.constr_of_global (Coqlib.lib_ref "core.eq.type"))
  with _ -> assert false
			...
			begin
			  ...
			  tclTHENLIST[
			    ...
			    intros_with_rewrite
                  ...
                  | Ind _ when EConstr.eq_constr sigma t (EConstr.of_constr (Universes.constr_of_global @@ Coqlib.lib_ref "core.False.type")) ->
