...
let clean_hyp_with_heq ptes_infos eq_hyps hyp_id env sigma =
  let coq_False = EConstr.of_constr (Universes.constr_of_global @@ Coqlib.lib_ref "core.False.type") in
  let coq_True = EConstr.of_constr (Universes.constr_of_global @@ Coqlib.lib_ref "core.True.type") in
  let coq_I = EConstr.of_constr (Universes.constr_of_global @@ Coqlib.lib_ref "core.True.I") in
...
(* 		   "apply wf_thm"  *)
  ...
  let lemma =
    match !tcc_lemma_ref with
     ...
     | Not_needed -> EConstr.of_constr (Universes.constr_of_global @@ Coqlib.lib_ref "core.True.I")
  in
