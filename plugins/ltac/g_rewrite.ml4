...
VERNAC COMMAND FUNCTIONAL EXTEND AddSetoid1 CLASSIFIED AS SIDEFF
   [ "Add" "Setoid" constr(a) constr(aeq) constr(t) "as" ident(n) ] ->
     [ fun ~atts ~st -> let open Vernacexpr in
         add_setoid (not (Locality.make_section_locality atts.local)) [] a aeq t n;
         st
     ]
  | [ "Add" "Parametric" "Setoid" binders(binders) ":" constr(a) constr(aeq) constr(t) "as" ident(n) ] ->
     [ fun ~atts ~st -> let open Vernacexpr in
         add_setoid (not (Locality.make_section_locality atts.local)) binders a aeq t n;
         st
     ]
  | [ "Add" "Morphism" constr(m) ":" ident(n) ]
    ...
    -> [ fun ~atts ~st -> let open Vernacexpr in
           add_morphism_infer (not (Locality.make_section_locality atts.local)) m n;
           st
       ]
  | [ "Add" "Morphism" constr(m) "with" "signature" lconstr(s) "as" ident(n) ]
    => [ Vernacexpr.(VtStartProof("Classic",GuaranteesOpacity,[n]), VtLater) ]
    -> [ fun ~atts ~st -> let open Vernacexpr in
           add_morphism (not (Locality.make_section_locality atts.local)) [] m s n;
           st
       ]
  | [ "Add" "Parametric" "Morphism" binders(binders) ":" constr(m)
    ...
    => [ Vernacexpr.(VtStartProof("Classic",GuaranteesOpacity,[n]), VtLater) ]
    -> [ fun ~atts ~st -> let open Vernacexpr in
           add_morphism (not (Locality.make_section_locality atts.local)) binders m s n;
           st
       ]
END
