...
let ml_file_copy input output =
  ...
  let pr s = fprintf o s in
  pr "(* DO NOT EDIT THIS FILE: automatically generated by ../configure *)\n";
  pr "(* see kernel/uint63_amd64.ml and kernel/uint63_x86.ml *)\n";
  try
    while true do
...
let write_uint63 () =
  if max_int = 1073741823 (* 32-bits *) then
    ml_file_copy "kernel/uint63_x86.ml" "kernel/uint63.ml"
  else (* 64 bits *)
    ml_file_copy "kernel/uint63_amd64.ml" "kernel/uint63.ml"
